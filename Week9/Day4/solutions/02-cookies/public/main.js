...
const cookieParser = (name) => {
  ...
  if (target) {
    const cookieSplit = target.split("=");
...
function restoreTheme() {
  // Your code here
  //   console.log("document cookie", document.cookie);
  //   console.log("cookie split ", document.cookie.split("="));

  const themeName = cookieParser("themeName");
...
function clearTheme() {
  // Your code here
  document.cookie = `themeName=;expires=${new Date(0).toUTCString()}`;
}
